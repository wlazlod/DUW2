...
if strcmp(arch,'win64')
   [flag, topdir]=system('adams2015_SE_x64 -top');
else
   [flag, topdir]=system('adams2015_SE -top');
end
if flag == 0
...
ADAMS_exec = '' ;
ADAMS_host = 'Daniel_Laptop' ;
ADAMS_cwd ='C:\Users\Daniel\Desktop\sem 2 mgr\PW\DUW 2\proj 2'  ;
ADAMS_prefix = 'manipulator' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'moment_1!moment_2' ;
ADAMS_outputs = 'fi_1!fi_2!om_wir_1!om_wir_2' ;
